...
namespace GoogleApi.Entities.Maps.Geocode.Response.Enums
{
    ...
    public enum GeometryLocationType
    {
        ...
        /// </summary>
        [EnumMember(Value = "ROOFTOP")] Rooftop,
        ...
        /// </summary>
        [EnumMember(Value = "RANGE_INTERPOLATED")] RangeInterpolated,
        ...
        /// </summary>
        [EnumMember(Value = "GEOMETRIC_CENTER")] GeometricCenter,

        /// <summary>
        /// Indicates that the returned result is approximate.
        /// </summary>
        [EnumMember(Value = "APPROXIMATE")] Approximate
    }
}