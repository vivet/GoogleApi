...
namespace GoogleApi.Entities.Places.AutoComplete.Request
{
    ...
    public class PlacesAutoCompleteRequest : BasePlacesRequest, IRequestQueryString
    {
        ...
        /// <summary>
        /// The character position in the input term at which the service uses text for predictions. For example, if the input is 'Googl' and the completion point is 3, 
        /// the service will match on 'Goo'. The offset should generally be set to the position of the text caret. If no offset is supplied, 
        /// the service will use the entire term.        
        /// </summary>
